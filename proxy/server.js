...
function buildAvoidRepeatContext() {
  ...
  return `\n【直近ほかのリクエストで提案したばかりのアイテム（同じ質問への回答は特に、できる限りこれらと違うアイテムを選ぶこと。色や色番号だけを変えた言い換え（例：同じブランドの同じ形のコートを色違いで出す）も重複とみなし、避けること）】\n${parts.join('\n')}`;
}
...
- 質問する観点は、その時点で一番情報が不足しているものを1つだけ選ぶ：
  ...
  - シーン・目的がすでに明確な場合：季節感・時間帯・天候・なりたい雰囲気（爽やか/大人っぽい/韓国風/シンプル等）のうち、最も提案の質を左右しそうなもの1つ
  - 初心者でまだ自分に何が似合うか分からない様子の場合：好みの系統をいくつか例示して選んでもらう（例：「きれいめ」「カジュアル」「モード」など）
- 質問は1回に1つだけ。矢継ぎ早に何個も質問しない
- 【絶対ルール】会話履歴の中で、自分（アシスタント）がすでに一度でも質問を投げかけていたら、今回は絶対に質問してはいけない。ユーザーの回答が短い・情報が不完全であっても、追加で聞き返すことは禁止。その時点で分かっている情報だけを使って、必ず今回でフルのコーデ提案を行うこと。「もう一つだけ」と2問目を聞くのは絶対禁止。質問できるのは会話全体を通して最初の1回のみ
- この対話は「初心者が自分に似合うもの・したいお洒落を見つける手助け」が目的。事務的な聞き取りではなく、親しみやすいスタイリストとの会話として自然な文体にする` : '';
      ...
      const varietyHints = [
        ...
        'アウターの選択を、アーバンリサーチのステンカラーコートに偏らず、無印良品・GU・ZARA・カーハートWIP・パタゴニア・ジャーナルスタンダード等、いつもと違うブランド・形状（マウンテンパーカー、ブルゾン、Gジャン等）も積極的に検討する',
...
${userProfile?.ngItems ? `\n【最優先の絶対ルール】ユーザーはこのアイテムを希望していない：${userProfile.ngItems}。これは下記のどんなトレンド情報・多様性のヒント・定番アイテムの提案よりも優先される。
重要：これはカテゴリとして解釈すること。例えば「スニーカー」がNGなら、Adidas Samba・Stan Smith・Gazelle・Campus、Nike Air Force 1、New Balance等、具体的なブランド名・型番のスニーカーも全てNGに含まれる（「スニーカー」という単語自体が提案文に出るかどうかではなく、実際にスニーカーという種類の靴かどうかで判断すること）。同様に「デニム」がNGなら、色や加工の名称に関わらずデニム素材のパンツ全般がNG。靴が丸ごとNGな場合は代わりにローファー・サンダル・ブーツ等、別カテゴリの履物を提案すること。\n` : ''}
【ブランド・アイテム詳細知識】
...
・メイク系統（レディース中心）：ナチュラルメイク/韓国風メイク/ガーリーメイク/クールモードメイク
...
【2026年トレンド知識】
・スタイル系統：ミニマルシック/Y2Kリバイバル/ゴープコア/バレアコア/上品ミニマル/ストリート/モード/韓国系カジュアル/サブカル/フェミニン/マスキュリン/ジェンダーレス
...
・韓国系カジュアル最新：パデッド/キルティング素材のショルダーバッグが定番化（韓国コーデ投稿の9割がショルダー型）、ティアードフリルミニスカートが人気。※蝶モチーフ・蝶刺繍は「幼く見える」と実際に判断されたため、この系統の提案には使わないこと。柄物より無地・上質素材での質感勝負が今の韓国系カジュアルの主流
・スニーカー：機能性よりコーディネート映え重視のヒュブリッドシルエット（厚底×クラシックの組み合わせ等）が主流に
・カラー最新：ラベンダー/ミントグリーン/オフホワイトが韓国系春夏コーデで人気急上昇。上記の既存カラートレンドと併用してよい

【2026年8月調査追記（2026-07-28更新）】
・帽子・ヘッドウェアが海外Z世代コーデの主役アクセサリーとして急浮上：ピルボックスハット、ペーパーボーイキャップ、もこもこニット帽など。トップス・アウターがシンプルな時ほど、帽子で一気に今っぽさを足せる。コーデ提案に帽子を含める場合は「アクセサリー：」欄に明記すること
・グレーパーカー×ベージュ系カーゴパンツ×白のクリーンなスニーカーという、色数を絞ったミニマルストリートの組み合わせが海外で定着。既存の「ミニマルシック」提案時の具体的な配色パターンとして活用してよい

【2026年8月調査追記2（2026-07-30更新）】
・白ノースリーブトップス×黒ショートパンツという、白と黒の潔いコントラストを効かせた2色コーデがSNSで大きな話題性を持つ着こなしとして急浮上。夏らしいシンプルながらインパクトのある配色として、カジュアル・ストリート系の提案時に活用してよい
・韓国メンズファッションはオーバーサイズ一辺倒から、スリムフィット×クリーンなプレッピー感への転換期。あわせて撥水・速乾素材やマルチポケット・ジップディテールを取り入れた「ミニマル×機能デザイン」のテック系スタイルが急成長中。ゴープコア/アウトドア提案時、機能素材への言及（撥水・速乾等）を加えると説得力が増す

${stylistDialogueBlock}

【返答ルール】
- 【提案の優先順位】複数の要素が競合する場合は、必ず次の順で優先すること：①TPO（シーン・目的）→②季節・天気→③体型・骨格タイプ→④年齢・性別→⑤ユーザーの好み・好きなスタイル→⑥好きなブランド→⑦予算。例えば「きれいめが好き」という好みがあっても、シーンがカジュアルな外出なら①②を優先してカジュアル寄りに調整する。「予算重視」等ユーザーが明示的に優先順位を指定した場合はその指定に従う
...
- 改善提案をする場合は「トップス：」「ボトムス：」「靴：」のように具体的なアイテム名で提示すること` }
  ...
  // おすすめブランド・商品一覧（骨格タイプ・スタイル傾向でパーソナライズ）
    ...
    req.on('end', () => {
      ...
      const CATALOG = [
        { brand: 'theory', item: 'ストレートテーパードパンツ', price: '¥28,000', category: 'ボトムス', skeletonTypes: ['ストレートタイプ'], styles: ['上品ミニマル', 'ミニマル/シンプル'] },
        { brand: 'ユニクロ', item: 'Uクルーネックカーディガン', price: '¥5,990', category: 'トップス', skeletonTypes: ['ストレートタイプ'], styles: ['ミニマル/シンプル'] },
        { brand: 'コモンプロジェクト', item: 'アキレスロートップ', price: '¥32,000', category: 'シューズ', skeletonTypes: ['ストレートタイプ'], styles: ['上品ミニマル'] },
        ...
        { brand: 'NUGU', item: 'キルティングショルダーバッグ', price: '¥8,900', category: 'バッグ', skeletonTypes: ['ウェーブタイプ'], styles: ['韓国系カジュアル'] },
        { brand: 'ZARA', item: 'ハイウエストデニムショーツ（無地）', price: '¥5,990', category: 'ボトムス', skeletonTypes: ['ウェーブタイプ'], styles: ['韓国系カジュアル', 'Y2K/レトロ'] },
        ...
        { brand: 'アクネ ストゥディオズ', item: 'オーバーサイズブレザー', price: '¥98,000', category: 'アウター', skeletonTypes: ['ストレートタイプ'], styles: ['モード/アバンギャルド', '上品ミニマル'] },
        ...
        { brand: 'ロンシャン', item: 'ル・プリアージュ トートバッグ', price: '¥25,000', category: 'バッグ', skeletonTypes: [], styles: ['上品ミニマル', 'ミニマル/シンプル'] },
      ];
