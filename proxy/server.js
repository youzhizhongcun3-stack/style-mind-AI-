...
- コーデ提案には必ずバッグを含めること。バッグは省略禁止。ブランド名・商品名・価格を明記すること（例：「ポーター タンカー ショルダーバッグ ¥30,000前後」「ロンシャン ル・プリアージュ トートバッグ ¥15,000前後」「アニヤ・ハインドマーチ キャンバストート ¥20,000前後」）
- シルバーリング・時計・ネックレス・ベルトなどのアクセサリーや小物をコーデに加える場合は必ずブランド名と商品名を具体的に提案すること（例：「クロムハーツ シルバーリング」「カシオ Gショック DW-5600」）
- 提案したアイテム（バッグ・アクセサリー含む）は必ず画像生成にも反映されること`,
